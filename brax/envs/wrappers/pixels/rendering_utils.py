...
def build_objects_for_cache(sys: brax.System, n_envs: int):
    ...
    for obj in objs:
        ...
        obj.instance.double_sided = jnp.array(obj.instance.double_sided).reshape(1,)
        #obj.instance = obj.instance.replace(double_sided = jnp.array(obj.instance.double_sided).reshape(1,))
