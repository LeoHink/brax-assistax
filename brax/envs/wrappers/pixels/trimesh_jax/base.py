...
# from brax.envs.wrappers.pixels.trimesh_jax.ray.ray_pyembree import RayMeshIntersector
...
from .visual.color import DefaultsHolder
...
class TrimeshPre:
    ...
    access to the Trimesh class to be init, but the Trimesh class *also* needs
    access to those objects during its own init. This is a catch-22 that we cannot
    get around with the flax.struct.dataclass frozen attributes.

    To get around this issue, we use this class. This class only holds a couple of
    things, and the "outer" class (Trimesh) will access these items via a property
    decorator.
    """
...
class Trimesh:
    # vertices: np.ndarray
    # faces: np.ndarray
    trimesh: Optional[TrimeshPre] = None
    visual: Optional[ColorVisuals] = None
    # face_normals: Optional[np.ndarray] = None
    # vertex_normals: Optional[np.ndarray] = None
    ray: Optional[RayMeshIntersector] = None
    permutator: Optional[permutate.Permutator] = None
    ...
    def create(cls, vertices, faces):
        ...
        ray = ray_module.ray_triangle.RayMeshIntersector(class_pre)
        permutator = permutate.Permutator(class_pre)
        nearest = proximity.ProximityQuery(class_pre)
        # Here we need to compute the normals!
        return cls(class_pre, visual, ray, permutator, nearest)
    ...
    @jax.jit
    def compute_face_normals_and_triangles(self) -> Tuple[NDArray, NDArray]:
        _triangles = self.vertices[self.faces]
        ...
        face_normals = np.where(
            _valid.reshape(-1, 1).repeat(3, axis=-1), _normals, _padded
        )
        return face_normals, _triangles

    @jax.jit
    def compute_face_angles(self, _triangles: np.ndarray) -> NDArray:
        return triangles.angles(_triangles)

    @jax.jit
    def compute_vertex_normals(
        self, face_normals: np.ndarray, face_angles: np.ndarray
    ) -> NDArray:
...
#
#    @property
#    def moment_inertia(self) -> NDArray:
#        """
...
#
#    def moment_inertia_frame(self, transform: ArrayLike) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def principal_inertia_components(self) -> NDArray:
#        """
...
#
#    @property
#    def principal_inertia_vectors(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def principal_inertia_transform(self) -> NDArray:
#        """
...
#
#    @property
#    def symmetry_axis(self) -> Optional[NDArray]:
#        """
...
#
#    @property
#    def symmetry_section(self) -> Optional[NDArray]:
#        """
...
#
#    @caching.cache_decorator
#    def edges_unique_length(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def edges_unique_inverse(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_neighborhood(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_edges(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_angles(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_projections(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_convex(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_unshared(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_radius(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def face_adjacency_span(self) -> NDArray:
#        """
...
#        self.update_faces(self.nondegenerate_faces(height=height))
#
#    def nondegenerate_faces(self, height: float = tol.merge) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def facets_normal(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def facets_origin(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def facets_boundary(self) -> List[NDArray]:
#        """
...
#        self,
#        center_mass: Optional[NDArray] = None,
#        sigma: float = 0.0,
#        n_samples: int = 1,
#        threshold: float = 0.0,
#    ):
...
#
#    def outline(self, face_ids: Optional[NDArray] = None, **kwargs) -> Path3D:
#        """
...
#
#    @caching.cache_decorator
#    def vertex_defects(self) -> NDArray:
#        """
...
#
#    @caching.cache_decorator
#    def vertex_degree(self) -> NDArray:
#        """
